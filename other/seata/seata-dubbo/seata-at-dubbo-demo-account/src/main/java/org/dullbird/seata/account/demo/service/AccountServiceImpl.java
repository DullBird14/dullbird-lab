package org.dullbird.seata.account.demo.service;

import io.seata.core.context.RootContext;
import org.dullbird.seata.account.demo.dao.AccountDao;
...
public class AccountServiceImpl implements AccountService {
    ...
    public void reduceBalance(Long userId, Integer price) throws Exception {
        ...
        // <3> 扣除余额
        int updateCount = accountDao.reduceBalance(price, userId);
        // 扣除成功
        if (updateCount == 0) {
